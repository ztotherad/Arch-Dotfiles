# Generated by Powerlevel10k configuration wizard on 2020-07-16 at 20:08 SAST.
...
# blurred heads, sharp tails, 2 lines, solid, full frame, darkest-ornaments, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=34
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=240
  typeset -g POWERLEVEL9K_IP_FOREGROUND=82
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_BACKGROUND=40
